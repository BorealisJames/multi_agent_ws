...
namespace Formation2DWithYaw
{
                                                             ...
                                                             DistributedFormation::Common::Formation2DType& optFormationType)
    {
        ...
        for (int f = 0; f < formation2DBasePtrVec.size(); f++)
        {
            ...
            std::cout << "halfplaneConstraintA " << halfplaneConstraintA<< std::endl; 
            std::cout << "halfplaneConstraintb " << halfplaneConstraintb << std::endl; 
            // std::cout << "formationPtr formation jaobioan" << formationPtr->GetFormationJacobian() <<std::endl; 
            ...
            double optRefDeltaYaw = DistributedFormation::Common::MinusPiToPi(optVaraiblesVec(2));
