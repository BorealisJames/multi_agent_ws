...
namespace Formation3DWithRot
{
                                                             ...
                                                             DistributedFormation::Common::Formation3DType& optFormationType)
    {
        ...
        for (int f = 0; f < formation3DBasePtrVec.size(); f++)
        {
            ...
            double optRefDeltaQw = optVaraiblesVec(3);
            double optRefDeltaQx = optVaraiblesVec(4);
            double optRefDeltaQy = optVaraiblesVec(5);
            double optRefDeltaQz = optVaraiblesVec(6);
            double optRefDeltaSize = optVaraiblesVec(7);

            double optVaraiblesArray[8] = {optRefDeltaX,
                                           optRefDeltaY,
                                           optRefDeltaZ,
                                           optRefDeltaQw,
                                           optRefDeltaQx,
                ...
                discountedCost<minCost)
            {
                ...
                optDeltaQw = optRefDeltaQw;
                optDeltaQx = optRefDeltaQx;
                optDeltaQy = optRefDeltaQy;
                optDeltaQz = optRefDeltaQz;
