...
public:
    ...
    // output is [d_pt1x/d_deltaX, d_pt1x/d_deltaY, d_pt1x/d_delyaZ, ...  d_pt1x/d_deltaSize ;
    //            d_pt1y/d_deltaX, d_pt1y/d_deltaY, d_pt1y/d_delyaZ, ...  d_pt1y/d_deltaSize ;
    //            ...
    //            d_pt3z/d_deltaX, d_pt3z/d_deltaY, d_pt3z/d_delyaZ, ...  d_pt3z/d_deltaSize ;]
