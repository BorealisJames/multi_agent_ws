...
/*
 ...
 - the direction which the formation points to is Q_desired
...
public:
    ...
    // output is [d_pt1x/d_deltaX, d_pt1x/d_deltaY, d_pt1x/d_deltaZ, ...  d_pt1x/d_deltaSize ;
    //            d_pt1y/d_deltaX, d_pt1y/d_deltaY, d_pt1y/d_deltaZ, ...  d_pt1y/d_deltaSize ;
    //            ...
    //            d_pt2z/d_deltaX, d_pt2z/d_deltaY, d_pt2z/d_deltaZ, ...  d_pt2z/d_deltaSize ;]
